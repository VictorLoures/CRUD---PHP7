		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<table>
							<tr>
								<td id="nomeProduto">Nome do Produto</td>
								<td id="qteEstoque">Quantidade em Estoque</td>
								<td id="cod">Código </td>
								...
								<td id="edit-delet"></td>
								<td id="edit-edit"></td>
								<td id="edit-darBaixa"></td>
							</tr>
						<tbody>
							<?php $counter1=-1;  if( isset($cad) && ( is_array($cad) || $cad instanceof Traversable ) && sizeof($cad) ) foreach( $cad as $key1 => $value1 ){ $counter1++; ?>
							<tr>
								<td id="nomeProduto"><?php echo htmlspecialchars( $value1["nome"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></td>
								<td id="qteEstoque"><?php echo htmlspecialchars( $value1["qte"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
								<td id="cod"><?php echo htmlspecialchars( $value1["cod"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
